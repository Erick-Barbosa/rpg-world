...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(RPGWorld.MOD_ID);
    ...
    public static final DeferredBlock<Block> BLOCK1 = registerBlock("block1",
            () -> new Block(
                    BlockBehaviour.Properties.of()
                            .strength(1f)
    ...
    public static final DeferredBlock<BismuthLampBlock> BISMUTH_LAMP = registerBlock("bismuth_lamp",
